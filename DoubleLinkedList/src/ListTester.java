...
public class ListTester {
	...
	private void runTests() {
		...
		testEmptyList(newList, "newList"); // Given
		//empty to 1-element list
		testSingleElementList(emptyList_addToFrontA_A, "emptyList_addToFrontA_A", LIST_A, STRING_A);// Given
		...
		testSingleElementList(emptyList_listIterAddA_A, "emptyList_listIterAddA_A", LIST_A, STRING_A); // 62
		...
		testEmptyList(A_iterRemoveAfterNextA_emptyList, "A_iterRemoveAfterNextA_emptyList");// Iterator 
		testEmptyList(A_listIterRemoveAfterNextA_emptyList, "A_listIterRemoveAfterNextA_emptyList"); // Added 50
		testEmptyList(A_listIterRemoveAfterPreviousA_emptyList, "A_listIterRemoveAfterPreviousA_emptyList"); // Added 56
		//1-element to 2-element
		testTwoElementList(A_addToFrontB_BA, "A_addToFrontB_BA", LIST_BA, STRING_BA); // Given
		...
		testTwoElementList(A_listIterAddB_BA, "A_listIterAddB_BA", LIST_BA, STRING_BA); // Added 63
		testTwoElementList(A_listIterAddAfterNextB_AB, "A_listIterAddAfterNextB_AB", LIST_AB, STRING_AB); //Added 64
		testTwoElementList(A_listIterAddAfterPreviousB_BA, "A_listIterAddAfterPreviousB_BA", LIST_BA, STRING_BA); //Added 65
		//1-element to changed 1-element via set()
		testSingleElementList(A_set0B_B, "A_set0B_B", LIST_B, STRING_B); 
		testSingleElementList(A_listIterSetAfterNextB_B, "A_listIterSetAfterNextB_B", LIST_B, STRING_B); // Added 71
		testSingleElementList(A_listIterSetAfterPreviousB_B, "A_listIterSetAfterPreviousB_B", LIST_B, STRING_B); //Added 72
		...
		testSingleElementList(AB_iterRemoveAfterNextA_B, "AB_iterRemoveAfterNextA_B", LIST_B, STRING_B); // Iterator
		testSingleElementList(AB_iterRemoveAfterNextB_A, "AB_iterRemoveAfterNextB_A", LIST_A, STRING_A); // Iterator
		testSingleElementList(AB_listIterRemoveAfterNextA_B, "AB_listIterRemoveAfterNextA_B", LIST_B, STRING_B); // Added 51
		testSingleElementList(AB_listIterRemoveAfterNextB_A, "AB_listIterRemoveAfterNextB_A", LIST_A, STRING_A); // Added 52
		testSingleElementList(AB_listIterRemoveAfterPreviousA_B, "AB_listIterRemoveAfterPreviousA_B", LIST_B, STRING_B); // Added 57
		testSingleElementList(AB_listIterRemoveAfterPreviousB_A, "AB_listIterRemoveAfterPreviousB_A", LIST_A, STRING_A); // Added 58
		...
		testThreeElementList(AB_listIterAddC_CAB, "AB_listIterAddC_CAB", LIST_CAB, STRING_CAB); // Added 66
		testThreeElementList(AB_listIterAddAfterNextC_ACB, "AB_listIterAddAfterNextC_ACB", LIST_ACB, STRING_ACB); // Added 67
		testThreeElementList(AB_listIterAddAfterNextC_ABC, "AB_listIterAddAfterNextC_ABC", LIST_ABC, STRING_ABC); // Added 68
		testThreeElementList(AB_listIterAddAfterPreviousC_CAB, "AB_listIterAddAfterPreviousC_CAB", LIST_CAB, STRING_CAB); // Added 69
		testThreeElementList(AB_listIterAddAfterPreviousC_ACB, "AB_listIterAddAfterPreviousC_ACB", LIST_ACB, STRING_ACB); // Added 70
		...
		testTwoElementList(AB_listIterSetAfterNextC_CB, "AB_listIterSetAfterNextC_CB", LIST_CB, STRING_CB); // Added 73
		testTwoElementList(AB_listIterSetAfterNextC_AC, "AB_listIterSetAfterNextC_AC", LIST_AC, STRING_AC); // Added 74
		testTwoElementList(AB_listIterSetAfterPreviousC_CB, "AB_listIterSetAfterPreviousC_CB", LIST_CB, STRING_CB); // Added 75
		testTwoElementList(AB_listIterSetAfterPreviousC_AC, "AB_listIterSetAfterPreviousC_AC", LIST_AC, STRING_AC); // Added 76
		...
		testTwoElementList(ABC_iterRemoveAfterNextA_BC, "ABC_iterRemoveAfterNextA_BC", LIST_BC, STRING_BC); // Iterator
		testTwoElementList(ABC_iterRemoveAfterNextB_AC, "ABC_iterRemoveAfterNextB_AC", LIST_AC, STRING_AC); // Iterator
		testTwoElementList(ABC_iterRemoveAfterNextC_AB, "ABC_iterRemoveAfterNextC_AB", LIST_AB, STRING_AB); // Iterator
		testTwoElementList(ABC_listIterRemoveAfterNextA_BC, "ABC_listIterRemoveAfterNextA_BC", LIST_BC, STRING_BC); // Added 53
		testTwoElementList(ABC_listIterRemoveAfterNextB_AC, "ABC_listIterRemoveAfterNextB_AC", LIST_AC, STRING_AC); // Added 54
		testTwoElementList(ABC_listIterRemoveAfterNextC_AB, "ABC_listIterRemoveAfterNextC_AB", LIST_AB, STRING_AB); // Added 55
		testTwoElementList(ABC_listIterRemoveAfterPreviousA_BC, "ABC_listIterRemoveAfterPreviousA_BC", LIST_BC, STRING_BC); // Added 59
		testTwoElementList(ABC_listIterRemoveAfterPreviousB_AC, "ABC_listIterRemoveAfterPreviousB_AC", LIST_AC, STRING_AC); // Added 60
		testTwoElementList(ABC_listIterRemoveAfterPreviousC_AB, "ABC_listIterRemoveAfterPreviousC_AB", LIST_AB, STRING_AB); // Added 61
		...
		testThreeElementList(ABC_listIterSetAfterNextD_DBC, "ABC_listIterSetAfterNextD_DBC", LIST_DBC, STRING_DBC); // Added 77
		testThreeElementList(ABC_listIterSetAfterNextD_ADC, "ABC_listIterSetAfterNextD_ADC", LIST_ADC, STRING_ADC); // Added 78
		testThreeElementList(ABC_listIterSetAfterNextD_ABD, "ABC_listIterSetAfterNextD_ABD", LIST_ABD, STRING_ABD); // Added 79
		testThreeElementList(ABC_listIterSetAfterPreviousD_DBC, "ABC_listIterSetAfterPreviousD_DBC", LIST_DBC, STRING_DBC); // Added 80
		testThreeElementList(ABC_listIterSetAfterPreviousD_ADC, "ABC_listIterSetAfterPreviousD_ADC", LIST_ADC, STRING_ADC); // Added 81
		testThreeElementList(ABC_listIterSetAfterPreviousD_ABD, "ABC_listIterSetAfterPreviousD_ABD", LIST_ABD, STRING_ABD); // Added 82
...
//			break;
	 ...
	 * @return [A] after add(A)ABC_removeC_AB
	 */
	...
	/** Scenario: A -> removeFirst(A) -> empty list []
	 * @return [A] after removeFirst(A)
	 */
	...
	/** Scenario: A -> removeLast(A) -> empty list []
	 * @return [A] after removeLast(A)
	 */
	...
	/** Scenario: AB -> addAfter(C,B) -> [C,A,B]
	 * @return [C,A,B] after addToFront(C)
	 */
	...
	/** 50 - Scenario: A -> listIteratorRemoveAfterNextA -> [ ] 
	...
	/** 51 - Scenario: AB -> listIteratorRemoveAfterNextA -> [B] 
	...
	/** 52 - Scenario: AB -> listIteratorRemoveAfterNextB -> [A] 
	 * @return [A] after listIteratorRemoveAfterNextB
	 */
	...
	/** 53 - Scenario: ABC -> listIteratorRemoveAfterNextA -> [B,C] 
	...
	/** 54 - Scenario: ABC -> listIteratorRemoveAfterNextB -> [A,C] 
	 * @return [A,C] after listIteratorRemoveAfterNextB
	 */
	...
	/** 55 - Scenario: ABC -> listIteratorRemoveAfterNextC -> [A,B] 
	 * @return [A,B] after listIteratorRemoveAfterNextC
	 */
	...
	/** 56 - Scenario: [A] -> ListIterator(1) remove(A) after previous-> [ ]
	 * @return [ ] after ListIterator(1) remove(A) after previous
	 */
	...
	/** 57 - Scenario: [A,B] -> ListIterator(1) remove(A) after previous-> [B]
	 * @return [B] after ListIterator(1) remove(A) after previous
	 */
	...
	/** 58 - Scenario: [A,B] -> ListIterator(2) remove(B) after previous-> [A]
	 * @return [A] after ListIterator(2) remove(B) after previous
	 */
	...
	/** 59 - Scenario: [A,B,C] -> ListIterator(1) remove(A) after previous-> [B,C]
	 * @return [B,C] after ListIterator(1) remove(A) after previous
	 */
	...
	/** 60 - Scenario: [A,B,C] -> ListIterator(2) remove(B) after previous-> [A,C]
	 * @return [A,C] after ListIterator(2) remove(B) after previous
	 */
	...
	/** 61 - Scenario: [A,B,C] -> ListIterator(3) remove(C) after previous-> [A,B]
	 * @return [A,B] after ListIterator(3) remove(C) after previous
	 */
	...
	/** 62 - Scenario: [ ] -> ListIterator() add(A) -> [A]
	...
	/** 63 - Scenario: [A] -> ListIterator() add(B) -> [B,A]
	...
	/** 64 - Scenario: [A] -> ListIterator() add(B) after next -> [A,B]
	 * @return [A,B] after ListIterator() add(B) after next
	 */
	...
	/** 65 - Scenario: [A] -> ListIterator(1) add(B) after previous -> [B,A]
	 * @return [B,A] after ListIterator(1) add(B) after previous
	 */
	...
	/** 66 - Scenario: [A,B] -> ListIterator() add(C) -> [C,A,B]
	 * @return [C,A,B] after ListIterator() add(C)
	 */
	...
	/** 67 - Scenario: [A,B] -> ListIterator() add(C) after next -> [A,C,B]
	 * @return [A,C,B] after ListIterator() add(C) after next
	 */
	...
	/** 68 - Scenario: [A,B] -> ListIterator() add(C) after next -> [A,B,C]
	 * @return [A,B,C] after ListIterator() add(C) after next
	 */
	private IndexedUnsortedList<Integer> AB_listIterAddAfterNextC_ABC(){ // 68
		IndexedUnsortedList<Integer> list = A_addToRearB_AB();
		ListIterator<Integer> it = list.listIterator();
		it.next();
		it.next();
	...
	/** 69 - Scenario: [A,B] -> ListIterator(1) add(C)AfterPrevious-> [A,C,B]
	 * @return [A,C,B] after ListIterator(1) add(C)AfterPrevious
	 */
	private IndexedUnsortedList<Integer> AB_listIterAddAfterPreviousC_CAB(){ 
		IndexedUnsortedList<Integer> list = A_addToRearB_AB();
		ListIterator<Integer> it = list.listIterator(1);
		it.previous();
		it.add(ELEMENT_C);
	...
	/** 70 - Scenario: [A,B] -> ListIterator(2) add(C) -> [A,C,B]
	 * @return [A,C,B] after ListIterator(2) add(C)
	 */
	private IndexedUnsortedList<Integer> AB_listIterAddAfterPreviousC_ACB(){
		IndexedUnsortedList<Integer> list = A_addToRearB_AB();
		ListIterator<Integer> it = list.listIterator(2);
		it.previous();
		it.add(ELEMENT_C);
	...
	/** 71 - Scenario: [A] -> ListIterator() set(B) after next -> [B]
	 * @return [B] after ListIterator() set(B) after next
	 */
	...
	/** 72 - Scenario: [A] -> ListIterator(1) set(B) after previous -> [B]
	 * @return [B] after ListIterator(1) set(B) after previous
	 */
	private IndexedUnsortedList<Integer> A_listIterSetAfterPreviousB_B(){ 
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A();
		ListIterator<Integer> it = list.listIterator(1);
		it.previous();
		it.set(ELEMENT_B);
	...
	/** 73 - Scenario: [A,B] -> ListIterator() set(C) after next -> [C,B]
	 * @return [C,B] after ListIterator() set(C) after next
	 */
	private IndexedUnsortedList<Integer> AB_listIterSetAfterNextC_CB(){
		IndexedUnsortedList<Integer> list = A_addToRearB_AB();
		ListIterator<Integer> it = list.listIterator();
		it.next();
		it.set(ELEMENT_C);
	...
	/** 74 - Scenario: [A,B] -> ListIterator() set(C) after next -> [A,C]
	 * @return [A,C] after ListIterator() set(C) after next
	 */
	private IndexedUnsortedList<Integer> AB_listIterSetAfterNextC_AC(){ 
		IndexedUnsortedList<Integer> list = A_addToRearB_AB();
		ListIterator<Integer> it = list.listIterator();
		it.next();
		it.next();
	...
	/** 75 - Scenario: [A,B] -> ListIterator(1) set(C) after previous -> [C,B]
	 * @return [C,B] after ListIterator(1) set(C) after previous
	 */
	...
	/** 76 - Scenario: [A,B] -> ListIterator(2) set(C) after previous -> [A,C]
	 * @return [A,C] after ListIterator(2) set(C) after previous
	 */
	private IndexedUnsortedList<Integer> AB_listIterSetAfterPreviousC_AC(){ 
		IndexedUnsortedList<Integer> list = A_addToRearB_AB();
		ListIterator<Integer> it = list.listIterator(2);
		it.previous();
		it.set(ELEMENT_C);
	...
	/** 77 - Scenario: [A,B,C] -> ListIterator() set(D) after next -> [D,B,C]
	 * @return [D,B,C] after ListIterator() set(D) after next
	 */
	private IndexedUnsortedList<Integer> ABC_listIterSetAfterNextD_DBC(){ 
		IndexedUnsortedList<Integer> list = AB_addToRearC_ABC();
		ListIterator<Integer> it = list.listIterator();
		it.next();
		it.set(ELEMENT_D);
	...
	/** 78 - Scenario: [A,B,C] -> ListIterator() set(D) after next -> [A,D,C]
	 * @return [A,D,C] after ListIterator() set(D) after next
	 */
	private IndexedUnsortedList<Integer> ABC_listIterSetAfterNextD_ADC(){ 
		IndexedUnsortedList<Integer> list = AB_addToRearC_ABC();
		ListIterator<Integer> it = list.listIterator();
		it.next();
		it.next();
	...
	/** 79 - Scenario: [A,B,C] -> ListIterator() set(D) after next -> [A,B,D]
	 * @return [A,B,D] after ListIterator() set(D) after next
	 */
	...
	/** 80 - Scenario: [A,B,C] -> ListIterator(1) set(D) after previous -> [D,B,C]
	 * @return [D,B,C] after ListIterator(1) set(D) after previous
	 */
	private IndexedUnsortedList<Integer> ABC_listIterSetAfterPreviousD_DBC(){ 
		IndexedUnsortedList<Integer> list = AB_addToRearC_ABC();
		ListIterator<Integer> it = list.listIterator(1);
		it.previous();
		it.set(ELEMENT_D);
	...
	/** 81 - Scenario: [A,B,C] -> ListIterator(2) set(D) after previous -> [A,D,C]
	 * @return [A,D,C] after ListIterator(2) set(D) after previous
	 */
	...
	/** 82 - Scenario: [A,B,C] -> ListIterator(3) set(D) after previous -> [A,B,D]
	 * @return [A,B,D] after ListIterator(3) set(D) after previous
	 */
	...
	private Scenario<Integer> A_listIterRemoveAfterNextA_emptyList = () -> A_listIterRemoveAfterNextA_emptyList(); // 50
	private Scenario<Integer> AB_listIterRemoveAfterNextA_B = () -> AB_listIterRemoveAfterNextA_B(); // 51
	private Scenario<Integer> AB_listIterRemoveAfterNextB_A = () -> AB_listIterRemoveAfterNextB_A(); // 52
	private Scenario<Integer> ABC_listIterRemoveAfterNextA_BC = () -> ABC_listIterRemoveAfterNextA_BC(); // 53
	private Scenario<Integer> ABC_listIterRemoveAfterNextB_AC = () -> ABC_listIterRemoveAfterNextB_AC(); // 54
	private Scenario<Integer> ABC_listIterRemoveAfterNextC_AB = () -> ABC_listIterRemoveAfterNextC_AB(); // 55
	private Scenario<Integer> A_listIterRemoveAfterPreviousA_emptyList = () -> A_listIterRemoveAfterPreviousA_emptyList(); // 56
	private Scenario<Integer> AB_listIterRemoveAfterPreviousA_B = () -> AB_listIterRemoveAfterPreviousA_B(); // 57
	private Scenario<Integer> AB_listIterRemoveAfterPreviousB_A = () -> AB_listIterRemoveAfterPreviousB_A(); // 58
	private Scenario<Integer> ABC_listIterRemoveAfterPreviousA_BC = () -> ABC_listIterRemoveAfterPreviousA_BC(); // 59
	private Scenario<Integer> ABC_listIterRemoveAfterPreviousB_AC = () -> ABC_listIterRemoveAfterPreviousB_AC(); // 60
	private Scenario<Integer> ABC_listIterRemoveAfterPreviousC_AB = () -> ABC_listIterRemoveAfterPreviousC_AB(); // 61
	private Scenario<Integer> emptyList_listIterAddA_A = () -> emptyList_listIterAddA_A(); // 62
	private Scenario<Integer> A_listIterAddB_BA = () -> A_listIterAddB_BA(); // 63
	private Scenario<Integer> A_listIterAddAfterNextB_AB = () -> A_listIterAddAfterNextB_AB(); // 64
	private Scenario<Integer> A_listIterAddAfterPreviousB_BA = () -> A_listIterAddAfterPreviousB_BA(); // 65
	private Scenario<Integer> AB_listIterAddC_CAB = () -> AB_listIterAddC_CAB(); // 66
	private Scenario<Integer> AB_listIterAddAfterNextC_ACB = () -> AB_listIterAddAfterNextC_ACB(); // 67
	private Scenario<Integer> AB_listIterAddAfterNextC_ABC = () -> AB_listIterAddAfterNextC_ABC(); // 68
	private Scenario<Integer> AB_listIterAddAfterPreviousC_CAB = () -> AB_listIterAddAfterPreviousC_CAB(); // 69
	private Scenario<Integer> AB_listIterAddAfterPreviousC_ACB = () -> AB_listIterAddAfterPreviousC_ACB(); // 70
	private Scenario<Integer> A_listIterSetAfterNextB_B = () -> A_listIterSetAfterNextB_B(); // 71
	private Scenario<Integer> A_listIterSetAfterPreviousB_B = () -> A_listIterSetAfterPreviousB_B(); // 72
	private Scenario<Integer> AB_listIterSetAfterNextC_CB = () -> AB_listIterSetAfterNextC_CB(); // 73
	private Scenario<Integer> AB_listIterSetAfterNextC_AC = () -> AB_listIterSetAfterNextC_AC(); // 74
	private Scenario<Integer> AB_listIterSetAfterPreviousC_CB = () -> AB_listIterSetAfterPreviousC_CB(); // 75
	private Scenario<Integer> AB_listIterSetAfterPreviousC_AC = () -> AB_listIterSetAfterPreviousC_AC(); // 76
	private Scenario<Integer> ABC_listIterSetAfterNextD_DBC = () -> ABC_listIterSetAfterNextD_DBC(); // 77
	private Scenario<Integer> ABC_listIterSetAfterNextD_ADC = () -> ABC_listIterSetAfterNextD_ADC(); // 78
	private Scenario<Integer> ABC_listIterSetAfterNextD_ABD = () -> ABC_listIterSetAfterNextD_ABD(); // 79
	private Scenario<Integer> ABC_listIterSetAfterPreviousD_DBC = () -> ABC_listIterSetAfterPreviousD_DBC(); // 80
	private Scenario<Integer> ABC_listIterSetAfterPreviousD_ADC = () -> ABC_listIterSetAfterPreviousD_ADC(); // 81
	private Scenario<Integer> ABC_listIterSetAfterPreviousD_ABD = () -> ABC_listIterSetAfterPreviousD_ABD(); // 82

 ...
 * Modifications by @author Jorge Tejada
 */
public class ListTester {
	...
	private void runTests() {
		...
		testSingleElementList(emptyList_addToRearA_A, "emptyList_addToRearA_A", LIST_A, STRING_A);// NEW ADDED TEST
		testSingleElementList(emptyList_addA_A, "emptyList_addA_A", LIST_A, STRING_A);// NEW ADDED TEST
		testSingleElementList(emptyList_add0A_A, "emptyList_add0A_A", LIST_A, STRING_A); // NEW ADDED TEST
		testSingleElementList(AB_IterRemoveA_B, "AB_IterRemoveA_B", LIST_B, STRING_B); //NEW ITERATOR TEST ADDED
		testSingleElementList(AB_IterRemoveB_A, "AB_IterRemoveB_A", LIST_A, STRING_A); //NEW ITERATOR TEST ADDED
		testSingleElementList( emptyList_iteratorAddA_A, " emptyList_iteratorAddA_A", LIST_A, STRING_A);
		//1-element to empty list
		testEmptyList(A_remove0_emptyList, "A_remove0_emptyList");//Added test
		testEmptyList(A_removeFirst_emptyList, "A_removeFirst_emptyList");// NEW ADDED TEST
		testEmptyList(A_removeLast_emptyList, "A_removeLast_emptyList");// NEW ADDED TEST
		testEmptyList(A_removeA_emptyList,"A_removeA_emptyList");//NEW ADDED TEST
		testEmptyList(A_iterRemoveA_emptyList,"A_iterRemoveA_empty");// NEW ADDED TEST
		testEmptyList(A_listIterIterRemoveA_emptyList, "A_listIterIterRemoveA_emptyList");
		testEmptyList(A_iterRemoveAfterPrevious_emptyList,"A_iterRemoveAfterPrevious_emptyList");
		//1-element to 2-element
		testTwoElementList(A_addAfterBA_AB, "A_addAfterBA_AB", LIST_AB, STRING_AB);//NEW ADDED TEST
		testTwoElementList(A_addToFrontB_BA, "A_addToFrontB_BA", LIST_BA, STRING_BA);
		testTwoElementList(A_add0B_BA, "A_add0B_BA", LIST_BA, STRING_BA);// Added test
		testTwoElementList(A_add1B_AB, "A_add1B_AB", LIST_AB, STRING_AB);// Added test
		testTwoElementList(A_addToRearB_AB, "A_addToRearB_AB", LIST_AB, STRING_AB);// Added test
		testTwoElementList(A_addB_AB, "A_addB_AB", LIST_AB,STRING_AB);// Added test
		testTwoElementList(A_iteratorAddBnewIterator_BA, "A_iteratorAddBnewIterator_BA", LIST_BA, STRING_BA);
		testTwoElementList(A_iteratorAddBAfterNext_AB, "A_iteratorAddBAfterNext_AB", LIST_AB, STRING_AB);
		testTwoElementList(A_iteratorAddBAfterPrevious_BA, "A_iteratorAddBAfterPrevious_BA", LIST_BA, STRING_BA);
		//1-element to changed 1-element via set()
		testSingleElementList( A_set0B_B, " A_set0B_B", LIST_B, STRING_B);// Added test
		testSingleElementList(A_iteratorSetBAfterNext_B, "A_iteratorSetBAfterNext_B",LIST_B, STRING_B);
		testSingleElementList(A_iteratorSetBAfterPrevious_B, "A_iteratorSetBAfterPrevious_B", LIST_B, STRING_B);
		//2-element to 1-element
		testSingleElementList(AB_removeB_A, "AB_removeB_A",LIST_A, STRING_A);// Added test
		testSingleElementList(AB_removeFirst, "AB_removeFirst", LIST_B, STRING_B);//NEW ADDED TEST
		testSingleElementList(AB_removeLast_A, "AB_removeLast_A ", LIST_A, STRING_A);//Added test
		...
		testSingleElementList(AB_iterRemoveAfterPrevious_B,"AB_iterRemoveAfterPrevious_B", LIST_B, STRING_B);
		testSingleElementList(AB_iterRemoveAfterPreviousB_A, "AB_iterRemoveAfterPreviousB_A", LIST_A, STRING_A);
		//2-element to 3-element
		testThreeElementList(AB_addC_ABC, "AB_addC_ABC", LIST_ABC, STRING_ABC); // NEW ADDED TEST
		testThreeElementList(AB_addToFrontC_CAB,"AB_addToFrontC_CAB", LIST_CAB,STRING_CAB);//NEW ADDED TEST
		testThreeElementList(AB_addToRearC_ABC, "AB_addToRearC_ABC", LIST_ABC, STRING_ABC);//NEW ADDED TEST
		testThreeElementList(AB_addAfterCA_ACB, "AB_addAfterCA_ACB",LIST_ACB, STRING_ACB);// NEW ADDED TEST
		testThreeElementList(AB_addAfterCB_ABC,"AB_addAfterCB_ABC", LIST_ABC, STRING_ABC);// NEW ADDED TEST
		...
		testThreeElementList(AB_iteratorAddCNewIterator_CAB, "AB_iteratorAddCNewIterator_CAB",LIST_CAB,STRING_CAB);
		testThreeElementList(AB_iteratorAddCAfterNext_ACB, "AB_iteratorAddCAfterNext_ACB ", LIST_ACB, STRING_ACB);
		testThreeElementList(AB_iteratorAddCAfterNext_ABC, "AB_iteratorAddCAfterNext_ABC",LIST_ABC, STRING_ABC);
		testThreeElementList(AB_iteratorAddCAfterPrevious_CAB, "AB_iteratorAddCAfterPrevious_CAB", LIST_CAB,STRING_CAB);
		testThreeElementList(AB_iteratorAddCAfterPrevious_ACB, "AB_iteratorAddCAfterPrevious_ACB",LIST_ACB, STRING_ACB);
		//2-element to changed 2-element via set()
		testTwoElementList(AB_set0C_CB, "AB_set0C_CB", LIST_CB, STRING_CB);// Added test
		testTwoElementList(AB_set1C_AC,"AB_set1C_AC",LIST_AC, STRING_AC);
		testTwoElementList(AB_iteratorSetCAfterNext_CB,"AB_iteratorSetCAfterNext_CB", LIST_CB, STRING_CB);
		testTwoElementList(AB_iteratorSetCAfterNext_AC, "AB_iteratorSetCAfterNext_AC", LIST_AC, STRING_AC);
		testTwoElementList(AB_iteratorSetCAfterPrevious_CB,"AB_iteratorSetCAfterPrevious_CB", LIST_CB, STRING_CB);
		testTwoElementList(AB_iteratorSetCAfterPrevious_AC, "AB_iteratorSetCAfterPrevious_AC", LIST_AC, STRING_AC);
		//3-element to 2-element
		testTwoElementList(ABC_removeA_BC, "ABC_removeA_BC",  LIST_BC, STRING_BC);// Added test
		testTwoElementList(ABC_removeC_AB, "ABC_removeC_AB",LIST_AB, STRING_AB) ;// Added test
		...
		testTwoElementList(ABC_remove0_BC, "ABC_remove0_BC",  LIST_BC, STRING_BC);// Added test
		testTwoElementList(ABC_remove1_AC, "ABC_remove1_AC",  LIST_AC, STRING_AC);// Added test
		testTwoElementList(ABC_remove2_AB,"ABC_remove2_AB", LIST_AB, STRING_AB);// NEW ADDED TEST
		testTwoElementList(ABC_IterRemoveA_BC, "ABC_IterRemoveA_BC",LIST_BC, STRING_BC);// NEW ITERATOR TEST ADDED
		testTwoElementList(ABC_removeB_AC, "ABC_removeB_AC",LIST_AC, STRING_AC);
		testTwoElementList(ABC_IterRemoveB_AC,"ABC_IterRemoveB_AC", LIST_AC, STRING_AC);//NEW ITERATOR TEST ADDED
		testTwoElementList(ABC_IterRemoveC_AB, "ABC_IterRemoveC_AB", LIST_AB, STRING_AB);//NEW ITERATOR TEST ADDED
		...
		testThreeElementList(ABC_set0D_DBC, "ABC_set0D_DBC", LIST_DBC, STRING_DBC);//NEW ADDED TEST
		testThreeElementList(ABC_set1D_ADC,"ABC_set1D_ADC",LIST_ADC, STRING_ADC);//NEW ADDED TEST
		testThreeElementList(ABC_set2D_ABD,"ABC_set2D_ABD", LIST_ABD, STRING_ABD);//NEW ADDED TEST
		testThreeElementList( ABC_interatorSetDAfterNext_DBC," ABC_interatorSetDAfterNext_DBC", LIST_DBC, STRING_DBC);
		testThreeElementList(ABC_interatorSetDAfterNext_ADC,"ABC_interatorSetDAfterNext_ADC",LIST_ADC, STRING_ADC);
		testThreeElementList(ABC_interatorSetDAfterNext_ABD,"ABC_interatorSetDAfterNext_ABD",LIST_ABD, STRING_ABD);
		testThreeElementList(ABC_iteratorSetDAfterPrevious_DBC,"ABC_iteratorSetDAfterPrevious_DBC", LIST_DBC, STRING_DBC);
		testThreeElementList(ABC_iteratorSetDAfterPrevious_ADC,"ABC_iteratorSetDAfterPrevious_ADC", LIST_ADC, STRING_ADC);
...
///////////////////////////////////// ADDED SCENARIOS	
	 ...
	 */
	private IndexedUnsortedList<Integer>AB_removeFirst(){
		IndexedUnsortedList<Integer> list = A_addB_AB();
		list.removeFirst();
		return list;
	}
	private Scenario<Integer>AB_removeFirst = () -> AB_removeFirst();
	...
	/** Scenario 34: [A,B,C] -> removeLast() -> [A,B] 
	...
	/** Scenario 36: [A,B,C] -> remove(B) -> [A,C] 
	...
	/**Scenario 42: [A,B,C] -> set(1,D) -> [A,D,C]
	...
	/**Scenario 43: [A,B,C] -> set(2,D) -> [A,B,D]
...
///// ITERATOR SCENARIOS
	...
	/** Scenario 44: [A] -> iterator remove() after next() returns A -> []
	 * @return [] after  iterator remove() after next() returns A
	 */
	...
	/** Scenario 45: [A,B] -> iterator remove() after next() returns A -> [B]
	 * @return [B] after iterator remove() after next() returns A
	 */
	...
	/**Scenario 46: [A,B] -> iterator remove() after next() returns B -> [A]
	 * @return [A] after iterator remove() after next() returns B
	 */
	...
	/**Scenario 47: [A,B,C] -> iterator remove() after next() returns A -> [B,C]
	 * @return [B,C] after iterator remove() after next() returns A 
	 */
	...
	/**Scenario 48:  [A,B,C] -> iterator remove() after next() returns B -> [A,C]
	 * @return [A,C] after iterator remove() after next() returns B 
	 */
	...
	/**Scenario 49:  [A,B,C] -> iterator remove() after next() returns C -> [A,B]
	...
	/**Scenario 50: [A] -> listIterator remove() after next() returns A -> []
	 * @return [] after  listIterator remove() after next() returns A
	 */
	private IndexedUnsortedList<Integer> A_listIterIterRemoveA_emptyList() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A(); 
	...
	private Scenario<Integer> A_listIterIterRemoveA_emptyList = () -> A_listIterIterRemoveA_emptyList();
	
	/** Scenario 51: [A,B] -> listIterator remove() after next() returns A -> [B]
	 * @return [B] after listIterator remove() after next() returns A
	 */
	...
	/**Scenario 52: [A,B] -> listIterator remove() after next() returns B -> [A]
	 * @return [A] after listIterator remove() after next() returns B
	 */
	...
	/**Scenario 53: [A,B,C] -> listIterator remove() after next() returns A -> [B,C]
	 * @return [B,C] after listIterator remove() after next() returns A 
	 */
	...
	/**Scenario 54:  [A,B,C] -> listIterator remove() after next() returns B -> [A,C]
	 * @return [A,C] after listIterator remove() after next() returns B 
	 */
	...
	/**Scenario 55:  [A,B,C] -> listIterator remove() after next() returns C -> [A,B]
	 * @return [A,B] after listIterator remove() after next() returns C
	 */
	 ...
	 * @return A -> [B]
	 */
	private IndexedUnsortedList<Integer> AB_iterRemoveAfterPrevious_B(){
		IndexedUnsortedList<Integer> list = A_addB_AB();	
		ListIterator<Integer> it = list.listIterator(1);
		it.previous();
		it.remove();
	...
	private Scenario<Integer> AB_iterRemoveAfterPrevious_B = () -> AB_iterRemoveAfterPrevious_B();
	 ...
	 */
	private IndexedUnsortedList<Integer> emptyList_iteratorAddA_A(){
		IndexedUnsortedList<Integer> list = newList();
		ListIterator<Integer> it = list.listIterator(0);
		it.add(ELEMENT_A);
		return list;
	}
	private Scenario<Integer> emptyList_iteratorAddA_A = () -> emptyList_iteratorAddA_A();
	

	/**Scenario 63: [A] -> iterator add(B) with new iterator -> [B,A] 
	 * @return [B,A] after iterator add(B) with new iterator
	 */
	private IndexedUnsortedList<Integer> A_iteratorAddBnewIterator_BA(){
		IndexedUnsortedList<Integer> list = emptyList_addA_A();
		ListIterator<Integer> it = list.listIterator(0);
		it.add(ELEMENT_B);
		return list;
	}
	private Scenario<Integer> A_iteratorAddBnewIterator_BA = () -> A_iteratorAddBnewIterator_BA();
	
	/** Scenario 64: [A] -> iterator add(B) after next() returns A -> [A,B]
	 * @return A -> [A,B]
	 */
	private IndexedUnsortedList<Integer> A_iteratorAddBAfterNext_AB(){
		IndexedUnsortedList<Integer> list = emptyList_addA_A();
		ListIterator<Integer> it = list.listIterator();
		it.next();
		it.add(ELEMENT_B);
	...
	private Scenario<Integer> A_iteratorAddBAfterNext_AB = () -> A_iteratorAddBAfterNext_AB();
	
	/**Scenario 65: [A] -> iterator add(B) after previous() returns A -> [B,A]
	 * @return A -> [B,A]
	 */
	private IndexedUnsortedList<Integer> A_iteratorAddBAfterPrevious_BA(){
		IndexedUnsortedList<Integer> list = emptyList_addA_A();
		ListIterator<Integer> it = list.listIterator(1);
		it.previous();
		it.add(ELEMENT_B);
	...
	private Scenario<Integer> A_iteratorAddBAfterPrevious_BA = () -> A_iteratorAddBAfterPrevious_BA();
	
	
	/**Scenario 66: [A,B] -> iterator add(C) with new iterator -> [C,A,B]
	 * @return [C,A,B] after iterator add(C) with new iterator
	 */
	private IndexedUnsortedList<Integer> AB_iteratorAddCNewIterator_CAB(){
		IndexedUnsortedList<Integer> list = A_iteratorAddBAfterNext_AB();
		ListIterator<Integer> it = list.listIterator(0);
		it.add(ELEMENT_C);
		return list;
	}
	private Scenario<Integer> AB_iteratorAddCNewIterator_CAB = () -> AB_iteratorAddCNewIterator_CAB();
	
	
	/**Scenario 67: [A,B] -> iterator add(C) after next() returns A -> [A,C,B]
	 * @return A -> [A,C,B]
	 */
	private IndexedUnsortedList<Integer> AB_iteratorAddCAfterNext_ACB(){
		IndexedUnsortedList<Integer> list = A_iteratorAddBAfterNext_AB();
		ListIterator<Integer> it = list.listIterator();
		it.next();
		it.add(ELEMENT_C);
	...
	private Scenario<Integer> AB_iteratorAddCAfterNext_ACB = () -> AB_iteratorAddCAfterNext_ACB();
	
	
	/**Scenario 68: [A,B] -> iterator add(C) after next() returns B -> [A,B,C]
	 * @return B -> [A,B,C]
	 */
	private IndexedUnsortedList<Integer> AB_iteratorAddCAfterNext_ABC(){
		IndexedUnsortedList<Integer> list = A_iteratorAddBAfterNext_AB();
		ListIterator<Integer> it = list.listIterator(1);
		it.next();
		it.add(ELEMENT_C);
	...
	private Scenario<Integer> AB_iteratorAddCAfterNext_ABC = () -> AB_iteratorAddCAfterNext_ABC();
	
	
	/**Scenario 69: iterator add(C) after previous() returns A -> [C,A,B]
	 * @return A -> [C,A,B]
	 */
	private IndexedUnsortedList<Integer> AB_iteratorAddCAfterPrevious_CAB(){
		IndexedUnsortedList<Integer> list = A_iteratorAddBAfterNext_AB();
		ListIterator<Integer> it = list.listIterator(1);
		it.previous();
		it.add(ELEMENT_C);
	...
	private Scenario<Integer> AB_iteratorAddCAfterPrevious_CAB = () -> AB_iteratorAddCAfterPrevious_CAB();
	
	
	/**Scenario 70: [A,B] -> iterator add(C) after previous() returns B -> [A,C,B]
	 * @return B -> [A,C,B]
	 */
	private IndexedUnsortedList<Integer> AB_iteratorAddCAfterPrevious_ACB(){
		IndexedUnsortedList<Integer> list = A_iteratorAddBAfterNext_AB();
		ListIterator<Integer> it = list.listIterator(2);
		it.previous();
		it.add(ELEMENT_C);
	...
	private Scenario<Integer> AB_iteratorAddCAfterPrevious_ACB = () -> AB_iteratorAddCAfterPrevious_ACB();
	
	/**Scenario 71:[A] -> iterator set(B) after next() returns A -> [B]
	 * @return returns A -> [B]
	 */
	private IndexedUnsortedList<Integer> A_iteratorSetBAfterNext_B(){
		IndexedUnsortedList<Integer> list = emptyList_addA_A();;
		ListIterator<Integer> it = list.listIterator();
		it.next();
		it.set(ELEMENT_B);
	...
	private Scenario<Integer> A_iteratorSetBAfterNext_B = () -> A_iteratorSetBAfterNext_B();
	
	
	/**Scenario 72: [A] -> iterator set(B) after previous() returns A -> [B]
	 * @return returns A -> [B]
	 */
	private IndexedUnsortedList<Integer>A_iteratorSetBAfterPrevious_B(){
		IndexedUnsortedList<Integer> list = emptyList_addA_A();;
		ListIterator<Integer> it = list.listIterator(1);
		it.previous();
		it.set(ELEMENT_B);
	...
	private Scenario<Integer> A_iteratorSetBAfterPrevious_B = () -> A_iteratorSetBAfterPrevious_B();
	
	
	/**Scenario 73: [A,B] -> iterator set(C) after next() returns A -> [C,B]
	 * @return A -> [C,B]
	 */
	private IndexedUnsortedList<Integer>AB_iteratorSetCAfterNext_CB(){
		IndexedUnsortedList<Integer> list = A_iteratorAddBAfterNext_AB();
		ListIterator<Integer> it = list.listIterator();
		it.next();
		it.set(ELEMENT_C);
	...
	private Scenario<Integer> AB_iteratorSetCAfterNext_CB = () -> AB_iteratorSetCAfterNext_CB();
	
	/**Scenario 74: [A,B] -> iterator set(C) after next() returns B -> [A,C]
	 * @return B -> [A,C]
	 */
	private IndexedUnsortedList<Integer>AB_iteratorSetCAfterNext_AC(){
		IndexedUnsortedList<Integer> list = A_iteratorAddBAfterNext_AB();
		ListIterator<Integer> it = list.listIterator(1);
		it.next();
		it.set(ELEMENT_C);
	...
	private Scenario<Integer>AB_iteratorSetCAfterNext_AC = () -> AB_iteratorSetCAfterNext_AC();
	
	
	/**Scenario 75: [A,B] -> iterator set(C) after previous() returns A -> [C,B]
	 * @return A -> [C,B]
	 */
	private IndexedUnsortedList<Integer>AB_iteratorSetCAfterPrevious_CB(){
		IndexedUnsortedList<Integer> list = A_iteratorAddBAfterNext_AB();
		ListIterator<Integer> it = list.listIterator(1);
		it.previous();
		it.set(ELEMENT_C);
	...
	private Scenario<Integer> AB_iteratorSetCAfterPrevious_CB = () -> AB_iteratorSetCAfterPrevious_CB();
	
	
	/**Scenario 76: [A,B] -> iterator set(C) after previous() returns B -> [A,C]
	 * @return B -> [A,C]
	 */
	private IndexedUnsortedList<Integer>AB_iteratorSetCAfterPrevious_AC(){
		IndexedUnsortedList<Integer> list = A_iteratorAddBAfterNext_AB();
		ListIterator<Integer> it = list.listIterator(2);
		it.previous();
		it.set(ELEMENT_C);
	...
	private Scenario<Integer>AB_iteratorSetCAfterPrevious_AC = () -> AB_iteratorSetCAfterPrevious_AC(); 
	
	
	/**Scenario 77: [A,B,C] -> iterator set(D) after next() returns A -> [D,B,C]
	 * @return returns A -> [D,B,C]
	 */
	private IndexedUnsortedList<Integer> ABC_interatorSetDAfterNext_DBC(){
		IndexedUnsortedList<Integer> list = AB_iteratorAddCAfterNext_ABC();
		ListIterator<Integer> it = list.listIterator();
		it.next();
		it.set(ELEMENT_D);
		return list;
	}
	private Scenario<Integer>  ABC_interatorSetDAfterNext_DBC = () ->  ABC_interatorSetDAfterNext_DBC();
	
	
	/**Scenario 78: [A,B,C] -> iterator set(D) after next() returns B -> [A,D,C]
	 * @return  B -> [A,D,C]
	 */
	private IndexedUnsortedList<Integer> ABC_interatorSetDAfterNext_ADC(){
		IndexedUnsortedList<Integer> list = AB_iteratorAddCAfterNext_ABC();
		ListIterator<Integer> it = list.listIterator(1);
		it.next();
		it.set(ELEMENT_D);
	...
	private Scenario<Integer> ABC_interatorSetDAfterNext_ADC = () -> ABC_interatorSetDAfterNext_ADC();
	
	
	/**Scenario 79: [A,B,C] -> iterator set(D) after next() returns C -> [A,B,D]
	 * @return C -> [A,B,D]
	 */
	private IndexedUnsortedList<Integer> ABC_interatorSetDAfterNext_ABD(){
		IndexedUnsortedList<Integer> list = AB_iteratorAddCAfterNext_ABC();
		ListIterator<Integer> it = list.listIterator(2);
		it.next();
		it.set(ELEMENT_D);
	...
	private Scenario<Integer> ABC_interatorSetDAfterNext_ABD = () -> ABC_interatorSetDAfterNext_ABD();
	
	/**Scenario 80:[A,B,C] -> iterator set(D) after previous() returns A -> [D,B,C] 
	 * @return A -> [D,B,C] 
	 */
	private IndexedUnsortedList<Integer>ABC_iteratorSetDAfterPrevious_DBC(){
		IndexedUnsortedList<Integer> list = AB_iteratorAddCAfterNext_ABC();
		ListIterator<Integer> it = list.listIterator(1);
		it.previous();
		it.set(ELEMENT_D);
	...
	private Scenario<Integer> ABC_iteratorSetDAfterPrevious_DBC = () -> ABC_iteratorSetDAfterPrevious_DBC();
	
	/**Scenario 81: [A,B,C] -> iterator set(D) after previous() returns B -> [A,D,C]
	 * @return B -> [A,D,C]
	 */
	private IndexedUnsortedList<Integer>ABC_iteratorSetDAfterPrevious_ADC(){
		IndexedUnsortedList<Integer> list = AB_iteratorAddCAfterNext_ABC();
		ListIterator<Integer> it = list.listIterator(2);
		it.previous();
		it.set(ELEMENT_D);
	...
	private Scenario<Integer> ABC_iteratorSetDAfterPrevious_ADC = () -> ABC_iteratorSetDAfterPrevious_ADC();
	
	/**Scenario 82: [A,B,C] -> iterator set(D) after previous() returns C -> [A,B,D]
	 * @return C -> [A,B,D]
	 */
	private IndexedUnsortedList<Integer>ABC_iteratorSetDAfterPrevious_ABD(){
		IndexedUnsortedList<Integer> list = AB_iteratorAddCAfterNext_ABC();
		ListIterator<Integer> it = list.listIterator(3);
		it.previous();
		it.set(ELEMENT_D);
	...
	private Scenario<Integer> ABC_iteratorSetDAfterPrevious_ABD = () -> ABC_iteratorSetDAfterPrevious_ABD();
